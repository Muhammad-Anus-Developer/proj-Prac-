...
<form>
            <div className="row App">
                <div className="col-md-6">
                    ...
                    <input className="px-3 py-2 mx-2 inpFoc" id="inp1" value="05:53" style={{ backgroundColor: "#e9edc9",marginBottom:"4%" }} disabled id="outlined-disabled" type="text" placeholder="User Name" />
    ...
    <option value="2">No</option>
                ...
                <label htmlFor="inp4" className="fw-bold clas2" >Remarks</label> <br />
                    <textarea id="inp4" className="px-2 mx-2 inpFoc" placeholder="Enter Remarks..." style={{ height: "80%", marginBottom:"3%" }} type="text" />
